		...
		Docs.classData =[{"id":"apidocs","iconCls":"icon-docs","text":"功能菜单","singleClickExpand":true,"leaf":false,"children":[                
				...
				]}/*,
				{
					"id":"processMng","iconCls":"icon-docs","text":"流程管理","singleClickExpand":true,"leaf":false,"children":[
                        ...
                        {"href":"processDefinedMng","text":"流程定义管理","id":"流程定义管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true},
                        {"href":"processTaskMng","text":"流程任务管理","id":"流程任务管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true},
                        {"href":"processDefFormMngPage","text":"流程表单管理","id":"流程表单管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true},
                        {"href":"viewProcessMng","text":"流程设计","id":"流程设计","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true},
                        {"href":"processTypeMng","text":"流程类型管理","id":"流程类型管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}
					]
				},
				{"id":"sysmng","iconCls":"icon-docs","text":"系统管理","singleClickExpand":true,"leaf":false,"children":[
                  {"href":"showOrganizationMngPage","text":"组织机构管理","id":"组织机构管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}
                  ,{"href":"showUserMngPage","text":"用户管理","id":"用户管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}
                  ,{"href":"viewRoleMng","text":"角色管理","id":"角色管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}
                  ,{"href":"viewMenuMng","text":"菜单管理","id":"菜单管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}
                  ,{"href":"viewModuleMng","text":"模块管理","id":"模块管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}
				  ]
				},
				{
					"id":"britReportMng","iconCls":"icon-docs","text":"报表管理","singleClickExpand":true,"leaf":false,"children":[
                      {"href":"britReportTypeMng","text":"报表类别管理","id":"报表类别管理","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true}  
