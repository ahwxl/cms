...
/*load href data is not able   wxl
...
//create a iframe wxl
if(_34c.href){
var iframeobj = top.document.createElement("iframe");
insertAdjacentElementSuper($("#"+_34c.id).get(0),"beforeEnd",iframeobj);
iframeobj.src =_34c.href;
iframeobj.width="100%";
iframeobj.height="100%";
iframeobj.setAttribute("frameborder", "0", 0);     
iframeobj.border=0;
iframeobj.scrolling = "auto";
iframeobj.setAttribute('allowtransparency','true',0);
//$("<iframe></iframe>").attr("src",_34c.href).attr("width","100%").attr("height","100%").attr("border","0").attr("scrolling","auto").attr("frameborder","0").appendTo($("#"+_34c.id));
}
