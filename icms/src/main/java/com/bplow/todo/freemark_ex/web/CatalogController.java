 ...
 * 
 * @author wangxiaolei
 * @version $Id: CatalogController.java, v 0.1 2018年4月28日 下午3:07:11 wangxiaolei Exp $
 */
...
public class CatalogController implements ServletContextAware {
    ...
    @ResponseBody
    public String showCatalogTree(String node, HttpServletRequest request,
    ...
    @ResponseBody
    public String getCatalogGridData(String node, HttpServletRequest request,
                                     HttpServletResponse response) {
     ...
     * @throws Exception 
     */
    @RequestMapping(value = "/doAddCatalog", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
    @ResponseBody
     ...
     * 修改栏目
     */
    @RequestMapping(value = "/doEditorCatalog", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
    @ResponseBody
